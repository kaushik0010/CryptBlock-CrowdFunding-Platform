...
const Card = ({ allcampaign, setOpenModel, setDonate, title }) => {
  ...
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-x1 md:max-w-full lg:max-w-screen-x1 md:px-24 lg:px-8 lg:py-20">
      <p className="py-16 text-2x1 font-bold leading-5">{title}</p>
        ...
        {allcampaign?.map((campaign, i) => (
          ...
          >
            ...
            <div className="py-5 pl-2">
              ...
              >
                <p className="text-2x1 font-bold leading-5">{campaign.title}</p>
              </a>
