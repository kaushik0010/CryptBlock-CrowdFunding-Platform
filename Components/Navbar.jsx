                ...
                <div className="p-5 bg-white border rounded shadow-sm">
                    ...
                    <div>
                      <button aria-label="Close Menu" title="Close Menu" className="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" onClick={() => setIsMenuOpen(false)}>
                        <svg className="w-5 text-gray-600" viewBox="0 0 24 24">
                          <path
                            fill="currentColor"
                            d="M19.7,4.3c-0.4-0.4-1-0.4-1.4,0L12,10.615.7,4.3c-0.4-0.4-1-0.4-1.4,05-0.4,1,0,1.416.3,6.31-6.3,6.3 -0.4,0.4-0.4,1,0,1.4C4.5,19.9,4.7,20,5,2050.5-0.1,0.7-0.316.3-6.316.3,6.3¢0.2,0.2,0.5,0.3,0.7,0.350.5-0.1,0.7-0.3 C0.4-0.4,0.4-1,0-1.4113.4,1216.3-6.3(20.1,5.3,20.1,4.7,19.7,4.32" />
                        </svg>
                      </button>
                    </div>
                  </div>
                  <nav>
                    <ul className="space-y-4">
                      {menuList.map((el, i) => (
                        <li key={i + 1}>
                          <a href="/" aria-label="Our Product" title="Our Product" className="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">
                            {el}
                          </a>
                        </li>
                      ))}
